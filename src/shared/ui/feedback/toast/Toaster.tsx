 ...
 *
 * store의 현재 토스트를 하단 탭바 위(좌우 12px)에 노출합니다.
...
export default function Toaster() {
  ...
  return (
    <div
      ...
      aria-live="polite"
      aria-atomic="true"
      className="pointer-events-none fixed right-3 bottom-[calc(3.75rem+env(safe-area-inset-bottom)+0.75rem)] left-3 z-toast"
    >
      {item && (
        <div
          className={cn(
