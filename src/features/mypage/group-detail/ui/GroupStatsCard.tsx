...
/**
 * 그룹 상세 페이지의 통계 카드입니다. 멤버 수·공유 글 수를 2열로 보여줍니다.
 *
 * @example
 * ```tsx
 * <GroupStatsCard
 ...
 * />
 */
export default function GroupStatsCard({ memberCount, productCount }: GroupStatsCardProps) {
  const stats = [
  ...
  return (
    <dl className="grid grid-cols-2 divide-x divide-gray-200 rounded-2xl border border-gray-200 py-5">
      {stats.map((stat) => (
