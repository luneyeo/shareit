 ...
 *
 * 하단 탭바(`TabBarFooter`)를 한 번만 렌더해 탭 그룹(대시보드·좋아요·마이페이지) 내에서
...
export default function TabLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      {/**
       * 하단 고정 TabBarFooter(FooterBase, fixed bottom-0)에 마지막 콘텐츠가 가려지지 않도록
       * 하단 여백을 확보합니다.
       * 여백 = TabBarFooter 높이(60px: FooterBase pt-2(8) + nav h-11(44) + pb-2(8)) + safe-area
       */}
